...
int set=19,neg=-90,pos=90,base=90;//Setpoint,Negative,Positive,Base values.neg shows tilt on other side of ultrasonic sensor
long cm1=set;                     //For filtering purpose
const double a=0.5;               //Exponential filter parameter
const int servoPin = 9;           //Servo pin

float Kp = 11.8;                                                    //Initial Proportional Gain
...
float readPosition() 
{
  ...
  if(cm > 38)              // 30 cm is the maximum position for the ball
  {cm=38;}                //Signal Conditioning for ultrasonic sensor  
